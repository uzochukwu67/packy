...
contract BettingPoolV2_1 is Ownable, ReentrancyGuard {
        ...
        )
    {
        ...
        // Calculate current market odds (reflects all bets placed)
        homeOdds = (totalPool * 1e18) / homePool;
        awayOdds = (totalPool * 1e18) / awayPool;
        drawOdds = (totalPool * 1e18) / drawPool;
